export const categories = [
  { name: "Электронные сигареты", order: 1 },
  { name: "Кальян", order: 2 },
  { name: "Табак", order: 3 },
  { name: "Чайный лист", order: 4 },
  { name: "Уголь", order: 5 },
  { name: "POD-системы", order: 6 },
  { name: "Жидкости", order: 7 },
  { name: "Самокурки", order: 8 },
  { name: "Аксессуары", order: 9 },
  { name: "Картриджи и испарители", order: 10 },
  { name: "Жевательный табак", order: 11 },
];
...
export const subCategories = [
  {
    ...
    categoryId: 1,
    order: 1,
    imageUrl: "/assets/images/unavailable.png",
  },
  {
    name: "Картриджи",
    categoryId: 1,
  ...
  {
    name: "Табак для самокурок",
    categoryId: 8,
    order: 2,
    imageUrl: "/assets/images/unavailable.png",
  },
  {
    name: "Картриджи и испарители",
    categoryId: 8,
    order: 3,
    imageUrl: "/assets/images/unavailable.png",
  },
